...
/**
 * Clase que implementa la interfaz de la lógica de negocio devolviendo datos de
 * obtenidos del servicio REST para la entidad User.
 *
...
public class ComprasManagerImplementation implements ComprasManager {
     ...
     * servicio RESTful del que se obtienen los datos para la aplicación
     * cliente.
     */
    ...
    public Collection<ComprasBean> getAllCompras(String usuario) {
        ...
        List<ComprasBean> compras = webClient.findAll_XML(new GenericType<List<ComprasBean>>() {
        }, usuario);
